...
*/
const js = programmingLanguage[0] + programmingLanguage[1];
...
const mdn = mozilla[0] + mozilla[7] + mozilla[14];
...
const languageLength = programmingLanguage.length;
...
*/
const indexOfV = winterMessage.indexOf('v');
...
const lastIndexOfN = winterMessage.lastIndexOf('n');

console.log(lastIndexOfN);
...
const authorInitials = harryPotterAuthor.slice(0, 4);
...
let newName = name.charAt(0).toUpperCase() + name.slice(1, 6) + ' ' + name.charAt(7).toUpperCase() + name.slice(8);
